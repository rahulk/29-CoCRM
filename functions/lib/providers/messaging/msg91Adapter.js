...
class Msg91Adapter {
    ...
    constructor() {
        ...
        if (!this.authKey)
            console.warn("MSG91_AUTH_KEY is missing");
        if (!this.integratedNumber)
            console.warn("MSG91_INTEGRATED_NUMBER is missing");
    }
    async sendWhatsApp(payload) {
        ...
        try {
            const response = await axios_1.default.post("https://api.msg91.com/api/v5/whatsapp/whatsapp-outbound-message/bulk/", waPayload, {
    ...
    async sendEmail(payload) {
        ...
        if (payload.attachments && payload.attachments.length > 0) {
            for (const att of payload.attachments) {
                try {
                    ...
                    if (att.href) {
                        const response = await axios_1.default.get(att.href, { responseType: 'arraybuffer' });
        ...
        try {
            const response = await axios_1.default.post("https://api.msg91.com/api/v5/email/send", emailPayload, {
                headers: { "authkey": this.authKey, "Content-Type": "application/json" }
            });
            return {
                success: true,
...
exports.Msg91Adapter = Msg91Adapter;
//# sourceMappingURL=msg91Adapter.js.map