...
exports.handleInboundMessage = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const firebase_1 = require("../config/firebase");
exports.handleInboundMessage = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        const leadsQuery = await firebase_1.db.collectionGroup("leads").where("phone", "==", phone).limit(1).get();
        if (leadsQuery.empty) {
...
//# sourceMappingURL=handleInboundMessage.js.map